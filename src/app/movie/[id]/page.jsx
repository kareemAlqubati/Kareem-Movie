  ...
  const fetchData = async (id) => {
    try {
      const [movieRes, creditsRes] = await Promise.all([
        fetch(`https://api.themoviedb.org/3/movie/${id}?api_key=05dcd03bf018854f4f916bca11dc23e4&language=en-US`), // Corrected "api_key"
        fetch(`https://api.themoviedb.org/3/movie/${id}/credits?api_key=05dcd03bf018854f4f916bca11dc23e4&language=en-US`) // Corrected "api_key"
      ]);
